...
//    private Random rand = new Random();
     ...
     **/
    public static final float ENEMY_WANDER_SPEED = 2.5f;
    /**
     * How fast the enemy moves towards its target, in units per second
     */
    public static final float ENEMY_CHASE_SPEED = 4.0f;
    /**
    ...
    public Enemy(Vector2 position, Raft targetRaft, LevelModel level) {
        super();
